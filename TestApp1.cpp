	...
	for (int boxX = 0; boxX < 3; boxX++)
	{
		for (int boxY = 0; boxY < 3; boxY++)
		{
			for (int boxZ = 0; boxZ < 3; boxZ++)
			{
				...
				BoxRenderComponent* boxRenderer = new BoxRenderComponent(newBox, mpVertexShader, mpPixelShader);
				TransformComponent* boxTransform = new TransformComponent(newBox, &XMMatrixTranslation(10.0f * boxX, 10.0f * boxY, 10.0f * boxZ));
				RotationAnimatorComponent* boxRotator = new RotationAnimatorComponent(newBox, XMFLOAT3(0.0f, 1.0f, 0.0f));
				...
				for (int i = 0; i < 5; i++)
				{
					...
					BoxRenderComponent* boxRenderer2 = new BoxRenderComponent(childBox, mpVertexShader, mpPixelShader);
					TransformComponent* childTransform = new TransformComponent(childBox, &(XMMatrixScaling(0.7f, 0.7f, 0.7f) * XMMatrixTranslation(0.0f, 2.0f, 0.0f)));
					RotationAnimatorComponent* rotator = new RotationAnimatorComponent(childBox, XMFLOAT3(0.0f, 1.0f, 1.0f));
				...
				for (int i = 0; i < 5; i++)
				{
					...
					BoxRenderComponent* boxRenderer2 = new BoxRenderComponent(childBox, mpVertexShader, mpPixelShader);
					TransformComponent* childTransform = new TransformComponent(childBox, &(XMMatrixScaling(0.7f, 0.7f, 0.7f) * XMMatrixTranslation(0.0f, 0.0f, 2.0f)));
					RotationAnimatorComponent* rotator = new RotationAnimatorComponent(childBox, XMFLOAT3(0.0f, 1.0f, 0.0f));
